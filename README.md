...
once ER gets created, you can find "service key" in the overview page of ER, every ER has unique service key, need to give it with the service provider to create er connection between azure and service provider. service provider also need to create ER.
